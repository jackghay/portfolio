...
export const projects = [
  {
    ...
    desc: 'Tablet-based digital menu that replaced paper menus and boosted average order value for a Moroccan restaurant.',
    ...
    problem: 'The restaurant was losing customers due to outdated paper menus that were expensive to reprint and couldn\'t show daily specials in real time.',
    solution: 'Built a tablet-based digital menu with real-time cloud sync, bilingual FR/AR support, and QR-code table linking — enabling instant menu updates and a modern dining experience.',
    result: 'Average order value increased. Menu updates now take 30 seconds instead of days. Customers frequently compliment the modern tablet experience.',
    demo: null,
    source: null,
  },
  {
    title: 'Product Photo Gallery',
    desc: 'Premium product showcase with smooth navigation, built for a client in Morocco looking to present their collection professionally online.',
    ...
    problem: 'The client needed a professional-grade gallery to showcase their product collection online, but existing platforms didn\'t offer the visual quality and responsiveness they wanted.',
    solution: 'Built a custom masonry gallery with lightbox viewer, lazy loading for fast performance, and fluid responsiveness — delivering a gallery that rivals premium commercial sites.',
    result: 'The client received positive feedback from peers on the professional presentation. Page load times remained under 2s even with high-resolution images.',
    demo: null,
    source: null,
  },
  {
    title: 'Social Platform Service',
    desc: 'Complete startup concept scoring 19.75/20. A service marketplace connecting providers with customers through real-time messaging and reviews.',
    ...
    problem: 'Service providers and customers lacked a dedicated platform to connect, communicate, and transact efficiently — existing solutions were either too generic or poorly designed.',
    solution: 'Designed and prototyped a full-service marketplace with real-time messaging, user profiles, ratings, and payment flow — all backed by a scalable architecture ready for production.',
    result: 'Awarded 19.75/20 by academic jury for innovation, architecture completeness, and polished execution. Recognized as a viable startup concept.',
    demo: null,
    source: null,
  },
  {
    title: 'AI-Powered Automation Tools',
    desc: 'Automation suite that reduced manual processing time for a client by automating document handling, data extraction, and testing workflows.',
    ...
    problem: 'A client\'s team was spending hours on repetitive document processing, data entry, and manual testing — consuming time that could go toward higher-value work.',
    solution: 'Built a collection of AI-powered automation tools: document pipelines, data extractors, automated test runners — with fallback mechanisms when AI confidence is low.',
    result: 'Manual processing time reduced. Accuracy maintained through automated quality gates. The client could reallocate team hours to strategic work.',
    demo: null,
    source: null,
  },
  {
    title: 'Chrome Extensions',
    desc: 'Browser extensions for productivity — built with Manifest V3, minimal permissions, and secure architecture trusted by users.',
    ...
    problem: 'Users needed browser tools to automate repetitive web tasks — form filling, data collection, UI customization — but existing extensions were insecure or used excessive permissions.',
    solution: 'Built Manifest V3 extensions with minimal permission models, service workers, and secure message passing — focusing on user privacy and Chrome Web Store compliance.',
    result: 'Extensions with zero security incidents. All pass Chrome Web Store review on first submission. Users appreciate the minimal permission requests.',
    demo: null,
    source: null,
  },
  {
    title: 'AI Research Projects',
    desc: 'Advancing Arabic NLP and computer vision through academic research at Master 2 STIQ level.',
    ...
    problem: 'Arabic NLP tools are significantly behind English counterparts — most libraries and pre-trained models lack proper Arabic support, limiting research and business applications.',
    solution: 'Developed custom preprocessing pipelines for Arabic text, implemented ML models using available frameworks, and documented reproducible methodology for future researchers.',
    result: 'Contributed methodologies and findings to the academic community. Built a foundation for practical Arabic NLP applications in business contexts.',
    demo: null,
    source: null,
  },
];
...
export const experience = [
  {
    ...
    period: '2023 — Present',
    desc: 'Building custom web applications, dynamic menus, product galleries, automation tools, and Chrome extensions for clients across Morocco, France, and remotely worldwide. Delivering clean, secure, and high-performance solutions with measurable business impact.',
...
export const testimonials = [
  {
    ...
    text: 'The digital menu transformed our service. Customers love the tablet experience, and I can update prices or add specials in seconds instead of reprinting everything. Amine delivered exactly what we needed, on time and within budget.',
    avatar: '',
  },
  {
    name: 'Sara M.',
    role: 'Business Owner, Rabat',
    text: 'I needed a professional gallery for my product collection. Amine built something far better than I imagined — smooth, beautiful, and fast. He listened carefully to my needs and delivered a solution that truly represents my brand.',
    avatar: '',
  },
  {
    name: 'Dr. Nadia O.',
    role: 'Academic Evaluator, STIQ Program',
    text: 'The social platform project scored 19.75/20 — among the highest in the program. The architecture was complete, the implementation polished, and the business model well-researched. This is the level of work I expect from top-tier graduates.',
    avatar: '',
  },
  {
    name: 'Youssef L.',
    role: 'Fellow Developer & Collaborator',
    text: 'Working with Amine on automation tools showed me his deep understanding of both code and business needs. He doesn\'t just build what you ask — he understands why you need it and builds something better. His AI work is applied with real precision.',
    avatar: '',
  },
];
...
export const processSteps = [
  {
    ...
    desc: '30-minute free call to understand your business, your problem, and whether we\'re a good fit. No commitment, no pressure.',
    icon: 'chat',
  },
  {
    step: 2,
    title: 'Architecture & Proposal',
    desc: 'I design the solution architecture, choose the right tech stack, and deliver a fixed-price proposal with clear timeline.',
    icon: 'arch',
  },
  {
    step: 3,
    title: 'Development Sprint',
    desc: 'I build your solution in focused 2-4 week sprints with regular demos. You see progress every step of the way.',
    icon: 'code',
  },
  {
    step: 4,
    title: 'Deploy & Support',
    desc: 'I deploy to production, hand over documentation, and provide 30 days of free support. Your project runs smoothly from day one.',
    icon: 'rocket',
  },
];

export const businessStats = [
  { value: '<2', label: 'Response Time', suffix: ' hrs' },
  { value: 2, label: 'Delivery', suffix: '-4 weeks' },
  { value: 90, label: 'Client Retention', suffix: '%' },
  { value: 3, label: 'Languages', suffix: ' (EN/AR/FR)' },
];
